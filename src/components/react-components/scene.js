  ...
  return (
    <Canvas>
      <a-scene
        ...
        <a-assets>
          <a-asset-item id='car-model' src='./Flying Car Master Anim.gltf'> </a-asset-item>
          <a-asset-item id='shirt-model' src='./tshirtfloat.gltf'> </a-asset-item>
        ...
        <Terrain />
        <UserRig />
        <a-entity class='cursor-listen' product scale='.1 .1 .1' material='shader:standard;color:#ff6600;metalness:1;roughness:0;emissive:#ffffff;emissiveIntensity:0.1;' w-shirt-gltf='gltf:#shirt-model' position='0 0 -10' cursor-listen />
        <button
          id='myEnterVRButton'
          style={{
            width: '3vw',
